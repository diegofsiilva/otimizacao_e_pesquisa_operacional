...
var KPI_CARDS = [
  { label: 'Total de Clientes',  value: '1.247',          sub: '+12 vs mês anterior',   subColor: 'text-green-700',  iconBg: 'bg-sky-100',   iconColor: '#0ea5e9',
  ...
  { label: 'Clusters Ativos',    value: '10',             sub: 'Sem alterações vs Jun/24', subColor: 'text-slate-500',  iconBg: 'bg-sky-100',   iconColor: '#0ea5e9',
  ...
  { label: 'Limite Total',       value: 'R$ 15.750.000',  sub: '+5.2% vs mês anterior',   subColor: 'text-green-700',  iconBg: 'bg-green-100', iconColor: '#22c55e',
  ...
  { label: 'Taxa de Aprovação',  value: '87.5%',          sub: '+2.3% vs ano anterior',   subColor: 'text-green-700',  iconBg: 'bg-amber-100', iconColor: '#f59e0b',
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-xs text-slate-500">Visão geral da carteira ativa · última simulação: Jun/2024</p>
      ...
      <div className="grid grid-cols-4 gap-4">
        {KPI_CARDS.map(function(k) {
          return (
            <div key={k.label} className="bg-[#F0EEE4] rounded-xl border border-slate-200 shadow-sm p-5">
      ...
      {/* Lista de clientes */}
      <div className="bg-[#F0EEE4] rounded-xl border border-slate-200 shadow-sm">
        {/* Header */}
              ...
              return (
                <button key={b.label}
                  className={'flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium border transition-colors '
                    + (b.primary ? 'bg-sky-500 text-white border-sky-500 hover:bg-sky-600' : 'bg-[#F0EEE4] text-slate-600 border-slate-200 hover:bg-slate-50')}>
                  {b.icon}{b.label}
                </button>
              );
            })}
        ...
        <div className="flex items-center gap-2 px-5 py-3">
          ...
          <button className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium border border-slate-200 bg-[#F0EEE4] text-slate-600 hover:bg-slate-50">
