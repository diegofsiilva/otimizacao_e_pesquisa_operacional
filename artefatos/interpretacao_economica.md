...
[Explicitar a unidade econômica da função objetivo (R$ de retorno acumulado no horizonte de uso de 22 meses) e o que significa o aumento marginal de uma unidade na variável de decisão $L_k$: o coeficiente $c_k$, ou seja, o retorno líquido por real de limite alocado àquele perfil.]

### 1.2 Qual é a lógica de geração de valor?
[Explicar como o modelo gera valor para o Banco Pan: melhor alocação de limite entre perfis, captura de receita de interchange nos clusters rentáveis e contenção de perdas esperadas — em vez da régua fixa atual. Ancorar no resultado real: retorno de ≈ R\$ 16,4 M/ano sobre um volume de ≈ R\$ 613 M, comparado à rentabilidade da política vigente.]

[Explicitar quais parâmetros puxam a rentabilidade para cima (propensão $\pi_k$, taxa de interchange $t$, horizonte $T$, utilização $\bar{u}$) e quais elevam o risco/reduzem o retorno (PD, calibração $\gamma_d$, LGD).]
